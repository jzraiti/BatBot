...
def login(path_to_api_key,path_to_credentials,path_to_client_settings):
    """login to instagram and openai

    Args:
        path_to_api_key (string): eg. ./secrets/apiKey.txt
        path_to_credentials (string): ./secrets/credentials.txt
        path_to_client_settings (string): ./secrets/ClientSettings.json

    Returns:
        Client: instagrapi client
    """
    CustomTools.openai_api_login(path_to_api_key)
    instagrapi_client = CustomTools.instagram_api_login(path_to_credentials,path_to_client_settings)
    return instagrapi_client
...
def generate_image_from_prompt_dalle3(prompt):
    # Specify the DALL-E endpoint
    endpoint = "https://api.openai.com/v1/images/generations"
...
def like_list_of_hashtag_medias(instagrapi_client, hashtags_list, max_number_of_likes):
    ...
    for hashtag in hashtags_list:
        ...
        random_number = random.randint(1, max_number_of_likes)
        CustomTools.like_hashtag_medias( instagrapi_client , hashtag , random_number )
